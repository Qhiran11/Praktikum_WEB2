    ...
    <form action="" method="POST"
      ...
      <div class="grid sm:grid-cols-2 gap-4">
        ...
        <div class="flex flex-col gap-2">
          ...
          <input type="text" id="Major_id_number" name="Major_id_number"
            class="px-3 py-2 border border-zinc-300 bg-slate-50" placeholder="e.g., F55122001">
        </div>
      </div>
      ...
      <div class="grid sm:grid-cols-2 gap-4">
        ...
        <div class="flex flex-col gap-2">
          ...
          <select name="gender" id="gender" class="px-3 py-2 border border-zinc-300 bg-slate-50">
        ...
        <div class="flex flex-col gap-2">
          ...
          <select name="majors" id="majors" class="px-3 py-2 border border-zinc-300 bg-slate-50">
        ...
        <div class="flex flex-col gap-2">
          ...
          <select name="status" id="status" class="px-3 py-2 border border-zinc-300 bg-slate-50">
        ...
        <div class="self-end flex gap-2">
          ...
          <button type="submit"
            class="bg-blue-50 border border-blue-500 text-blue-500 px-3 py-2 flex items-center gap-2">
